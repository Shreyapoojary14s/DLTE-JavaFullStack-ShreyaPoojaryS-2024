...
create sequence ACCOUNTID_SEQ2 start with 100 increment by 1;
...
alter table MYBANK_APP_ACCOUNT add constraint ACCOUNTID_SEQ2 primary key(ACCOUNT_ID);
...
CUSTOMER_ID NUMBER(10),
SENDER_NUMBER NUMBER(20),
BENEFICIARY_NUMBER NUMBER(20),
FOREIGN KEY (CUSTOMER_ID) REFERENCES MYBANK_APP_CUSTOMER(CUSTOMER_ID) ON DELETE CASCADE,
FOREIGN KEY (BENEFICIARY_NUMBER ) REFERENCES MYBANK_APP_ACCOUNT(ACCOUNT_NUMBER) ON DELETE CASCADE,
FOREIGN KEY (SENDER_NUMBER ) REFERENCES MYBANK_APP_ACCOUNT(ACCOUNT_NUMBER) ON DELETE CASCADE);
