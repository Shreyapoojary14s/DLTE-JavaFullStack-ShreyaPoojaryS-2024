...
public class TransactionEntity {
    ...
    public TransactionEntity(Long transaction_Id, Date transaction_Date, String transaction_To, String transaction_from, String transaction_amount, String transaction_remarks) {
    ...
    public static void setTransaction_remarks(String transaction_remarks) {
        this.transaction_remarks = transaction_remarks;
    }
